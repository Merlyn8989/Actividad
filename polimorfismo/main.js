...
class Inferioridad extends Complejos{
    diagnostico(){
        return`la persona ${this.nombre} tiene el complejo de ${this.tipo} por lo que se comporta ${this.comportamiento} y se debe a un rechazo o acoso sufrido al paciente`
    }
}

class Superioridad extends Complejos{
    diagnostico(){
        return`la persona ${this.nombre} tiene el complejo de ${this.tipo} por lo que se comporta ${this.comportamiento} y se debe a elogios constantes o fomentar su ego, también a miedos internos`
    }
}
